...
const mockTrendingPlansData: CardData[] = [
  {
    ...
    subtitle: "FRI-SAT",
    imageUrl:
      "https://images.unsplash.com/photo-1545128485-c400e7702796?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    iconType: "person",
    count: 10,
    location: "LA",
    emoji: "🔥",
...
const mockHotspotsData: CardData[] = [
  ...
  },
  {
    ...
    subtitle: "NEXT SAT",
    imageUrl:
      "https://images.unsplash.com/photo-1586105251261-72a756497a11?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80",
    iconType: "globe",
    count: 14,
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1532452119098-a3650b3c46d3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    iconType: "person",
    count: 42,
    location: "Beachfront",
    emoji: "🏝️",
...
const mockInterestsData: Interest[] = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1519214605650-76a613ee3245?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
  },
  {
    id: "interest_3",
    title: "Digital Nomad",
...
const mockExplorePlansData: Plan[] = [
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1545128485-c400e7702796?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    description:
      "Join us for an epic night out exploring the best clubs in Hollywood! We will start at 9pm and visit 3-4 of the hottest venues on the strip. Great for meeting new people and dancing the night away!",
    host: "NightBFF Team",
  },
  {
    id: "plan_detail_2",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1514933651103-005eec06c04b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80",
    description:
      "Experience the best views of Downtown LA from exclusive rooftop bars. We will visit 3 premium locations with signature cocktails and amazing skyline views. Perfect for networking and capturing Instagram-worthy moments.",
    host: "Sarah Johnson",
  },
  {
    id: "plan_detail_3",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1586105251261-72a756497a11?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80",
    description:
      "For true electronic music lovers! We are hitting the best underground techno venues in the Arts District. Featuring both established and emerging DJs in intimate warehouse spaces with incredible sound systems.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1532452119098-a3650b3c46d3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    description:
      "Start with a beautiful sunset on Venice Beach, then join our exclusive beach party with bonfires, music, and dancing under the stars. Bring your beach vibes and good energy!",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1532452119098-a3650b3c46d3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    description:
      "A sophisticated evening of classic jazz and craft cocktails at one of West Hollywood's most elegant speakeasies. Dress to impress and enjoy the smooth sounds of live performers.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1519214605650-76a613ee3245?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    description:
      "Join our unique 5K run along the beach at night, lit up with neon lights and glow-in-the-dark accessories. Finish with a beachfront party featuring DJs, food trucks, and plenty of photo ops.",
    host: "Active Nights",
  },
  {
    id: "plan_detail_7",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    description:
      "Be among the first to hear the newest tracks from rising star DJ Cosmic at this exclusive mansion party in the Hollywood Hills. Limited spots available!",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    description:
      "Ring in the New Year with style at our annual black-tie event featuring multiple dance floors, open premium bars, gourmet catering, and a spectacular midnight countdown with champagne toast.",
    host: "Elite Events",
  },
];
...
const mockNearbyUsersData: UserLocation[] = [
  ...
  },
  {
    ...
    name: "Jordan",
    profileImage:
      "https://images.unsplash.com/photo-1552058544-f2b08422138a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=688&q=80",
    location: {
  ...
  },
  {
    ...
    name: "Nev",
    profileImage:
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1887&q=80",
    location: {
  ...
  },
  {
    ...
    name: "Aaron",
    profileImage:
      "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80",
    location: {
...
const mockBffs: BffProfile[] = [
  ...
  },
  {
    ...
    age: 21,
    avatarUrl:
      "https://images.unsplash.com/photo-1531384441138-2736e62e0919?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80",
    isOnline: true,
    countryFlag: "🇮🇹", // Italy
  },
  {
  ...
  },
  {
    ...
    age: 32,
    avatarUrl:
      "https://images.unsplash.com/photo-1607990281513-2c110a25bd8c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2034&q=80",
    isOnline: true,
    countryFlag: "🇨🇦", // Canada
  },
];
...
const mockPopularGroupDetails: Record<string, PopularGroupDetail> = {
  group_1: {
    ...
    heroImageUrl:
      "https://images.unsplash.com/photo-1545128485-c400e7702796?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    description:
      "Join us for an unforgettable weekend exploring the best nightlife Los Angeles has to offer! We'll be hitting multiple exclusive clubs each night, with VIP access and no cover charges.",
    userAvatars: [
      AVATAR_URLS[0],
      AVATAR_URLS[1],
      AVATAR_URLS[2],
  ...
  group_2: {
    ...
    venue: {
      ...
      name: "Strip District",
      imageUrl:
        "https://images.unsplash.com/photo-1581350845039-694cfb3cc60a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    },
    organizer: {
      id: "org_2",
      name: "Marcus",
  ...
  group_3: {
    ...
    heroImageUrl:
      "https://images.unsplash.com/photo-1514214246283-d427a95c5d2f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    description:
      "Discover Miami's vibrant nightlife scene with our local experts! This 3-day adventure covers the best clubs in South Beach and downtown. You'll enjoy skip-the-line access to premium venues, a sunset yacht party, and plenty of time to enjoy Miami's beautiful beaches during the day.",
    userAvatars: [
      AVATAR_URLS[2],
      AVATAR_URLS[1],
      AVATAR_URLS[4],
...
const mockUserProfiles: { [key: string]: UserProfileDetail } = {
  bff_1: {
    ...
    aboutMe:
      "I love to travel and wanna meet new friends along the way ✌️ Will be solo traveling for the next 6 months. Down to go anywhere!",
    badges: ["Pro", "Verified"],
    socials: [
      { type: "instagram", isSet: false },
      { type: "tiktok", isSet: false },
    ],
    interests: ["Adventure", "Nature", "Road Trip", "Hiking", "Backpacking"],
    languages: ["English"],
  },
  bff_2: {
    // Add at least one more mock profile
    id: "bff_2",
    name: "Alex",
    age: 28,
    location: "Canada",
  ...
  tsune_1: {
    ...
    isVerified: true,
    profileImageUrls: [
      "https://images.unsplash.com/photo-1583512603805-3cc6b41f3edb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80",
    ], // Placeholder image
    aboutMe:
      "A Japanese studying in Shanghai. Would love to explore the world and looking for new friends",
    badges: ["Verified"],
    socials: [
      { type: "instagram", isSet: true },
  ...
  bff_4: {
    ...
    isVerified: false,
    profileImageUrls: [
      "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",
    ], // Placeholder image
    aboutMe:
      "Digital nomad exploring Southeast Asia. Always up for an adventure or a good coffee.",
  ...
  bff_5: {
    ...
    aboutMe:
      "Just moved here, looking for cool bars and music venues. Love photography!",
    badges: [],
    socials: [
      { type: "instagram", isSet: true },
      { type: "tiktok", isSet: false },
...
export const fetchPopularGroupDetail = async (
  groupId: string,
): Promise<PopularGroupDetail> => {
  ...
  const groupBase =
    mockNightlifeGroups.find((g) => g.id === groupId) ||
    mockExploreGroups.find((g) => g.id === groupId);
  ...
  const details: PopularGroupDetail = {
    ...
    userAvatars:
      (groupBase as NightlifeGroup).userAvatars ||
      (groupBase as ExploreGroupCardData).attendeeAvatars ||
      [],
...
export const fetchExploreGroups = async (
  ...
  if (
    ...
    return mockExploreGroups.filter(
      (group) =>
        group.locationFlag === filter ||
        group.location.toLowerCase().includes(filter.toLowerCase()),
    );
  }
...
export const loginUser = async (
  ...
  try {
    ...
    // We expect this placeholder call to potentially fail if the endpoint doesn't exist
    // or if it's a real failing endpoint.
    // The global interceptor in apiService.ts handles 401/403 errors.
    // For other errors from this specific placeholder call, we log a warning but proceed
    // with returning mock data to not break the UI flow during development.
    if (!(error.message && error.message.includes("Session expired"))) {
      // Avoid double logging for session expiry
      console.warn(
        "[mockService] Placeholder API call for loginUser failed (non-auth error), proceeding with mock data:",
        error.message,
      );
    }
    // NOTE: If the error IS an auth error (401/403), the interceptor in apiService.ts
    // will have already emitted 'authError' and AuthContext will handle logout.
    // If that happens, this function might not complete or its result might be irrelevant
    // as the user is redirected.
  }

  // Simulate actual mock logic after engaging interceptors
...
export const fetchConversationMessages = async (
  ...
  const mockMessages: ChatMessage[] = [
    ...
    },
    {
      ...
      }, // Use current user ID and avatar
...
export const fetchChatList = async (): Promise<ChatConversation[]> => {
  console.log("[Mock API] Fetching chat list...");

  try {
    // Placeholder call to engage interceptors
    await apiService.get("/chat/list-placeholder");
    console.log(
      "[mockService] Placeholder API call for fetchChatList successful (interceptors engaged).",
    );
  } catch (error: any) {
    if (!(error.message && error.message.includes("Session expired"))) {
      console.warn(
        "[mockService] Placeholder API call for fetchChatList failed (non-auth error), proceeding with mock data:",
        error.message,
      );
    }
    // Auth errors (401/403) handled by global interceptor.
  }
  ...
  const mockConversations: ChatConversation[] = [
    ...
    },
    {
      ...
      participants: [],
      lastMessage: {
        text: "Meeting confirmed for 2 PM.",
        timestamp: "9:45 AM",
        senderId: "user3",
      },
      unreadCount: 3,
  ...
  console.log("[Mock API] Chat list fetched successfully.");
